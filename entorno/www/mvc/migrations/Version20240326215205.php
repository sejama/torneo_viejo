 ...
 */
final class Version20240326215205 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cuartos (id INT AUTO_INCREMENT NOT NULL, partido1_id INT NOT NULL, partido2_id INT NOT NULL, partido3_id INT NOT NULL, partido4_id INT NOT NULL, play_off_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_6128B4FC1A71DF68 (partido1_id), UNIQUE INDEX UNIQ_6128B4FC8C47086 (partido2_id), UNIQUE INDEX UNIQ_6128B4FCB07817E3 (partido3_id), UNIQUE INDEX UNIQ_6128B4FC2DAF2F5A (partido4_id), UNIQUE INDEX UNIQ_6128B4FC1B790A7C (play_off_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE fin (id INT AUTO_INCREMENT NOT NULL, partido1_id INT NOT NULL, play_off_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_AD2EF2311A71DF68 (partido1_id), UNIQUE INDEX UNIQ_AD2EF2311B790A7C (play_off_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE play_off (id INT AUTO_INCREMENT NOT NULL, torneo_genero_categoria_id INT NOT NULL, oro TINYINT(1) NOT NULL, plata TINYINT(1) NOT NULL, bronce TINYINT(1) NOT NULL, INDEX IDX_F59DAD8CD7CF149E (torneo_genero_categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE semis (id INT AUTO_INCREMENT NOT NULL, partido1_id INT NOT NULL, partido2_id INT NOT NULL, play_off_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_4994C2281A71DF68 (partido1_id), UNIQUE INDEX UNIQ_4994C2288C47086 (partido2_id), UNIQUE INDEX UNIQ_4994C2281B790A7C (play_off_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE zona (id INT AUTO_INCREMENT NOT NULL, torneo_genero_categoria_id INT DEFAULT NULL, clasifican_oro SMALLINT DEFAULT NULL, clasifican_plata SMALLINT DEFAULT NULL, clasifican_bronce SMALLINT DEFAULT NULL, INDEX IDX_A786041ED7CF149E (torneo_genero_categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cuartos ADD CONSTRAINT FK_6128B4FC1A71DF68 FOREIGN KEY (partido1_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE cuartos ADD CONSTRAINT FK_6128B4FC8C47086 FOREIGN KEY (partido2_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE cuartos ADD CONSTRAINT FK_6128B4FCB07817E3 FOREIGN KEY (partido3_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE cuartos ADD CONSTRAINT FK_6128B4FC2DAF2F5A FOREIGN KEY (partido4_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE cuartos ADD CONSTRAINT FK_6128B4FC1B790A7C FOREIGN KEY (play_off_id) REFERENCES play_off (id)');
        ...
        $this->addSql('ALTER TABLE fin ADD CONSTRAINT FK_AD2EF2311A71DF68 FOREIGN KEY (partido1_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE fin ADD CONSTRAINT FK_AD2EF2311B790A7C FOREIGN KEY (play_off_id) REFERENCES play_off (id)');
        ...
        $this->addSql('ALTER TABLE play_off ADD CONSTRAINT FK_F59DAD8CD7CF149E FOREIGN KEY (torneo_genero_categoria_id) REFERENCES torneo_genero_categoria (id)');
        $this->addSql('ALTER TABLE semis ADD CONSTRAINT FK_4994C2281A71DF68 FOREIGN KEY (partido1_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE semis ADD CONSTRAINT FK_4994C2288C47086 FOREIGN KEY (partido2_id) REFERENCES partido (id)');
        $this->addSql('ALTER TABLE semis ADD CONSTRAINT FK_4994C2281B790A7C FOREIGN KEY (play_off_id) REFERENCES play_off (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cuartos DROP FOREIGN KEY FK_6128B4FC1A71DF68');
        $this->addSql('ALTER TABLE cuartos DROP FOREIGN KEY FK_6128B4FC8C47086');
        $this->addSql('ALTER TABLE cuartos DROP FOREIGN KEY FK_6128B4FCB07817E3');
        $this->addSql('ALTER TABLE cuartos DROP FOREIGN KEY FK_6128B4FC2DAF2F5A');
        $this->addSql('ALTER TABLE cuartos DROP FOREIGN KEY FK_6128B4FC1B790A7C');
        $this->addSql('ALTER TABLE equipo DROP FOREIGN KEY FK_C49C530BD7CF149E');
        $this->addSql('ALTER TABLE fin DROP FOREIGN KEY FK_AD2EF2311A71DF68');
        $this->addSql('ALTER TABLE fin DROP FOREIGN KEY FK_AD2EF2311B790A7C');
        ...
        $this->addSql('ALTER TABLE play_off DROP FOREIGN KEY FK_F59DAD8CD7CF149E');
        $this->addSql('ALTER TABLE semis DROP FOREIGN KEY FK_4994C2281A71DF68');
        $this->addSql('ALTER TABLE semis DROP FOREIGN KEY FK_4994C2288C47086');
        $this->addSql('ALTER TABLE semis DROP FOREIGN KEY FK_4994C2281B790A7C');
        ...
        $this->addSql('DROP TABLE cuartos');
