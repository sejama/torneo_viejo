 ...
 */
final class Version20240319222916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE play_off (id INT AUTO_INCREMENT NOT NULL, torneo_genero_categoria_id INT NOT NULL, INDEX IDX_F59DAD8CD7CF149E (torneo_genero_categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
