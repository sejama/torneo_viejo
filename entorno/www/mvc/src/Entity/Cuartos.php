...
#[ORM\Entity(repositoryClass: CuartosRepository::class)]
class Cuartos
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(cascade: ['persist', 'remove'])]
    #[ORM\JoinColumn(nullable: false)]
    private ?Partido $partido4 = null;

    #[ORM\OneToOne(inversedBy: 'cuartos', cascade: ['persist', 'remove'])]
    ...
    public function getPartido4(): ?Partido
    {
        return $this->partido4;
    }

    public function setPartido4(Partido $partido4): static
    {
